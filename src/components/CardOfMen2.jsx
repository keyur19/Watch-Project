...
const CardOfMen2 = ({ key, image, title, rs, desc, alt }) => {
  ...
  <img style={{objectFit:"cover"}}
    className="card-img-top imageh" src={image}
     alt = {alt} />
  <div className="card-body">
    <h4 style={{color:"hotpink", fontFamily:"serif"}} className="card-title">{title}</h4>
    ...
    <button
      style={{color: "hotpink", background:"rgb(251, 230, 255)", fontWeight:"700", border:"3px solid pink"}}
